...
public class MyVirtualGamingLeagueProvider : ILeagueProvider
{
    public IReadOnlyCollection<League> Leagues
    {
        get => new League[]
        {
            new League
            {
                SiteId = MyVirtualGamingSiteProvider.SITE_ID,
                Id = new Guid("5957b164-7bb5-4324-967a-16c3044260b2"),
                Name = "VGNHL National League",
                Info = new MyVirtualGamingLeagueInfo { LeagueId = "vgnhl" },
            ...
            new League
            {
                ...
                Info = new MyVirtualGamingLeagueInfo { LeagueId = "vgahl" },
                Tags = new Tags { "psn", "ea nhl", "6v6" },
                Enabled = true
            },
            ...
            new League
            {
                ...
                Info = new MyVirtualGamingLeagueInfo { LeagueId = "vgphl" },
                Tags = new Tags { "psn", "ea nhl", "6v6" },
                Enabled = true
            },
            ...
            new League
            {
                ...
                Info = new MyVirtualGamingLeagueInfo { LeagueId = "vghlwc" },
            ...
            new League
            {
                ...
                Name = "VGHL 3s League",
                Info = new MyVirtualGamingLeagueInfo { LeagueId = "vghl3" },
