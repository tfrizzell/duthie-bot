                                    ...
                                    Promise.all(rows.map(row => 
                                        new Promise(resolve => {
                                            ...
                                            if (item.type === 'bid') {
                                                ...
                                                message = message.replace(/The (.*?) have drafted (.*?) (\S+) overall in season (\d+) of the (.*?)/i, (match, team, player, position, season, league) => `${!item.customTeams ? 'The ' : ''}${team} have drafted ${util.tagUser(player, guild, false)} ${position} overall in the ${league} season ${season} draft!`);
                                            }
