...
module.exports = (runner, {timezone = 'America/New_York'} = {}) => ([
    ...
    // cron: 0 */5+2 20-23 * * *
    cron.job(`0 ${offsetSteps(12, 2)} 20-23 * * *`, runner.updateGames,   undefined, true, timezone, runner),
    ...
    // cron: 0 */5+4 14-15 * * *
    cron.job(`0 ${offsetSteps(12, 4)} 14-15 * * *`, runner.updateStars,   undefined, true, timezone, runner),   
