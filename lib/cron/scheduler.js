...
// cron: 0 16 4,16 * * *
cron.job(`0 16 4,16 * * *`,                           runner.updateLeagues,      undefined, true, timezone, runner);

// cron: 0 36 4,16 * * *
cron.job(`0 36 4,16 * * *`,                           runner.updateTeams,        undefined, true, timezone, runner);

// cron: 0 56 4,16 * * *
cron.job(`0 56 4,16 * * *`,                           runner.removeArchivedData, undefined, true, timezone, runner);
