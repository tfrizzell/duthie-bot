...
# CHANNEL (optional)
    When unregistering a watcher, you may specify the channel you wish to filter your watcher removal on. If excluded, only watchers with no channel associated will be removed.

    To remove watchers for all teams, use \`channel=*\`.`;
