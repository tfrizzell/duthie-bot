...
/**
 * Provides a generic `help` command.
 * @param {String} username - the name of the user requesting help
 */
const help = (username = 'user') => {
    return `Hello ${username}! Here is what you need to know about ${config.name}:
 ...
 * @param {String} username - the name of the user requesting help
 */
help.list = (username = 'user') => {
    return `Hello ${username}! Here is what you need to know about \`${config.prefix} list\`:
