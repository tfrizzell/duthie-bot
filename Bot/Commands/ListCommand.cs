...
public class ListCommand : BaseCommand
{
    ...
    {
        var siteOption = cmd.Options.FirstOrDefault(o => "site".Equals(o.Name))?.Value?.ToString();
        return (
    ...
    {
        var tagsOption = cmd.Options.FirstOrDefault(o => "tags".Equals(o.Name))?.Value?.ToString();
