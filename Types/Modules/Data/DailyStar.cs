...
{
    public override string Position { get; } = "Forward";
}

public class DailyStarDefense : DailyStarSkater
{
    public override string Position { get; } = "Defense";
}

public class DailyStarGoalie : DailyStar
{
    public override string Position { get; } = "Goalie";
    public decimal SavePct => (decimal)Saves / ShotsAgainst;
