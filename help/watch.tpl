...
# TYPE (required)
  There are currently 9 valid types:
      ...
      * bidding  - announces any winning bids that match your league and/or team filters
      * contract - announces any new contracts that match your league and/or team filters
